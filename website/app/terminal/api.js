...
export async function BuscarAgendamentos(data) {
  const args = {
    method: "POST",
    headers: {
  ...
  const url = process.env.API_URL + "/agendamento/gridterminal";
...
export async function ConfirmaPresenca(data) {
  const args = {
    method: "POST",
    headers: {
      Accept: "application/json",
  ...
  const url = process.env.API_URL + "/agendamento/updateTerminal";
