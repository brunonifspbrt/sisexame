...
import { usuarioEmailSchema } from "./schema";
import { useForm } from "react-hook-form";
import { yupResolver } from "@hookform/resolvers/yup";

export default function ReqEmail({ id }) {
  ...
  const {
    ...
    resolver: yupResolver(usuarioEmailSchema),
  });
  ...
  const onSubmit = async (data) => {
    ...
    // data.usuarioID = id;
    // data.urlSite = `${window.location.origin}/resetmail/${id}`; // adiciona o caminho do site para resetar senha
