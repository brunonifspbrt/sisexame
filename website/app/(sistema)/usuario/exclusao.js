...
export default function ExclusaoUsuario({ id, nome }) {
  ...
  return (
    <Modal show={modalOpen} onClose={handleClose}>
      <ModalHeader className="dark:text-white">Usuário - Exclusão</ModalHeader>
      <ModalBody className="dark:text-white">
        Deseja realmente remover usuário:{` "${nome}"`}?
      </ModalBody>
