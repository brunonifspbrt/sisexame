...
export default function ExclusaoPaciente({ id, nome }) {
  ...
  return (
    <Modal show={modalOpen} onClose={handleClose}>
      <ModalHeader className="dark:text-white">Paciente - Exclusão</ModalHeader>
      <ModalBody className="dark:text-white">
        Deseja realmente remover paciente:{` "${nome}"`}?
      </ModalBody>
