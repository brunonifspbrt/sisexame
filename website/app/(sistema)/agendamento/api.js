...
export async function Inserir(data) {
  ...
  const url = process.env.API_URL + "/agendamento";
  ...
  try {
    ...
    if (result.status === 200) {
      ...
      retorno.message = "Agendamento salvo com sucesso";
    } else {
...
export async function Listar(data) {
  const args = {
    method: "GET",
    headers: {
      "x-api-key": process.env.API_KEY,
...
export async function ListarGrid(data) {
  ...
  const url = process.env.API_URL + "/agendamento/gridagendamento";
...
export async function ListarPacientes(data) {
  ...
  const url = process.env.API_URL + "/agendamento/selectpacientes";
...
export async function ListarExames(data) {
  ...
  const url = process.env.API_URL + "/agendamento/selectexames";
...
export async function BuscarRegistro(id) {
  ...
  const url = process.env.API_URL + "/agendamento/" + id;
...
export async function Atualizar(data) {
  ...
  const url = process.env.API_URL + "/agendamento/" + data.id;
  ...
  try {
    ...
    if (result.status === 200) {
      //ações em caso de sucesso
      retorno.success = true;
      retorno.message = "Agendamento atualizado com sucesso";
    } else {
      //ações em caso de erro
      let errorMessage = "";
      if (resultData.errors != null) {
...
export async function ReenviarEmail(data) {
  const args = {
    method: "POST",
    headers: {
      Accept: "application/json",
  ...
  const url = process.env.API_URL + "/agendamento/emailagend";
...
export async function Cancelar(data) {
  const args = {
    method: "POST",
    headers: {
      Accept: "application/json",
  ...
  const url = process.env.API_URL + "/agendamento/cancela";
